...
void lcd_init()
{
    nrf_gpio_cfg_output(LCD_PIN_RS);
    nrf_gpio_cfg_output(LCD_PIN_CLK);
    nrf_gpio_cfg_output(LCD_PIN_B4);
    nrf_gpio_cfg_output(LCD_PIN_B5);
    nrf_gpio_cfg_output(LCD_PIN_B6);
    nrf_gpio_cfg_output(LCD_PIN_B7);
